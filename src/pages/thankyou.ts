export function thankYouPage(): string {
  return `<div class="min-h-screen bg-zinc-950 pt-32 pb-12">
    <div class="max-w-2xl mx-auto px-6">
      <div class="bg-zinc-900 rounded-2xl border border-zinc-800 p-12 text-center animate-fadeInUp">
        <div class="w-24 h-24 bg-green-600/10 rounded-full flex items-center justify-center mx-auto mb-8 animate-fadeInUp delay-200">
        ...
        <h1 class="text-4xl font-bold text-white mb-4 animate-fadeInUp delay-300">Thank You!</h1>
        ...
        <p class="text-gray-500 mb-8 animate-fadeInUp delay-500">In the meantime, feel free to call us at <a href="tel:+19105157779" class="text-amber-500 hover:text-amber-400 font-semibold">(910) 515-7779</a></p>
        <a href="/" class="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg px-6 py-3 font-semibold transition-colors animate-fadeInUp delay-500">
